  ...
  return (
    <section className="bg-slate-50 py-8">
      ...
      <div className=" flex flex-col items-center justify-center">
        ...
        <div className=" flex flex-col items-start justify-evenly space-y-8 md:space-y-0 md:grid md:grid-cols-8 md:grid-rows-2 md:gap-x-20 md:gap-y-10 my-10 p-5 text-lg">
          ...
          <Card className="p-5 self-start md:col-span-4 w-[300px] md:w-fit h-[180px] flex flex-col justify-between bg-teal-400 shadow-gray-200">
          ...
          <Card className="p-5 w-[370px] md:w-fit md:col-span-4 md:h-[152px] bg-teal-400 shadow-gray-200">
          ...
          <Card className="p-5 self-center justify-end md:col-span-3 bg-teal-400 shadow-gray-200">
          ...
          <Card className="p-5 md:col-span-3 md:col-start-5 bg-teal-400 shadow-gray-200">
